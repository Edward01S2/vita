...
$thumbnum		= of_get_option('of_thumbnail_number'); // Get number of thumbnails set in Theme Options
...
<div <?php post_class($postclasses); ?>>
  <div class="postphoto info <?php echo $autoplay; ?> random customspeed" data-speed="1000">
    <?php echo themewich_thumbnail_post_slideshow($featured_size, $post->ID, $thumbnum); // Defined in functions.php ?>
  </div>
</div>
<!-- End The Post -->