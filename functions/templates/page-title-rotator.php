            ...
            foreach($tw_options['intro'] as $index => $row) : ?>
              ...
              <?php if ($i > 1) {
                ...
                <?php if (isset($tw_options['intro'][$index][1]) && $tw_options['intro'][$index][1] != '') : ?>
                  <!-- Subtitle -->
                  <h<?php echo $tw_options['subheading']; ?> class="subtitle"><?php echo strip_tags( apply_filters('the_content', $tw_options['intro'][$index][1]) , '<a>, <br>, <i>' ); ?></h<?php echo $tw_options['subheading']; ?>>
                  <!-- End Subtitle -->
                <?php endif; ?>
